      ...
      {loading ? (
        ...
        <Box>
          ...
          <TabPanel value={tabValue} index={2}>
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography variant="subtitle1">Educational: Understanding PCA Results</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    ...
                    <Typography variant="body2" paragraph>
                      The explained variance indicates how much of the total variability in your data is captured by each principal component.
                    </Typography>
                    <Typography variant="body2" paragraph>
                      <strong>High explained variance (>70%)</strong> for the first 2-3 PCs suggests that your data has a simple underlying structure
                      that can be effectively represented in a low-dimensional space.
                    </Typography>
                    <Typography variant="body2" paragraph>
                      <strong>Moderate explained variance (40-70%)</strong> suggests that while the main patterns are captured,
                      there is still considerable information in higher dimensions.
                    </Typography>
                    <Typography variant="body2">
                      <strong>Low explained variance (&lt;40%)</strong> indicates a complex dataset where important patterns
                      are distributed across many dimensions.
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Typography variant="body2" paragraph>
                      Samples that cluster together in PCA space are similar to each other in the context of the gene expression patterns
                      that contribute most to the principal components.
                    </Typography>
                    <Typography variant="body2" paragraph>
                      <strong>Tight, well-separated clusters</strong> suggest distinct experimental conditions with reproducible effects.
                    </Typography>
                    <Typography variant="body2" paragraph>
                      <strong>Overlapping clusters</strong> may indicate that the biological differences between conditions
                      are subtle or that there is high biological variability.
                    </Typography>
                    <Typography variant="body2">
                      <strong>Outliers</strong> that don't cluster with their group may represent biological outliers or technical artifacts.
                    </Typography>
                  </Grid>
                  
                  <Grid item xs={12} md={6}>
                    <Typography variant="subtitle2" gutterBottom>
                      Interpreting Gene Loadings
                    </Typography>
                    <Typography variant="body2" paragraph>
                      Genes with high loading values (positive or negative) contribute most to the pattern captured by that principal component.
                    </Typography>
                    <Typography variant="body2" paragraph>
                      <strong>Genes with high PC1 loadings</strong> drive the primary axis of variation in your data.
                    </Typography>
                    <Typography variant="body2" paragraph>
                      <strong>Genes with high PC2 loadings</strong> drive the secondary axis of variation, orthogonal to PC1.
                    </Typography>
                    <Typography variant="body2">
                      Genes with high loadings on the same PC and same sign (+ or -) often have related biological functions
                      or are co-regulated.
                    </Typography>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Typography variant="body2" paragraph>
                      PCA is often an exploratory step that leads to more targeted analyses:
                    </Typography>
                    <Typography variant="body2" component="div">
                      <ul>
                        <li>Perform differential expression analysis on genes with high loadings</li>
                        <li>Conduct pathway enrichment analysis to identify biological processes</li>
                        <li>Investigate outlier samples for potential batch effects or biological significance</li>
                        <li>Consider other dimensionality reduction methods (t-SNE, UMAP) for non-linear patterns</li>
                        <li>Use the PC scores as input for clustering or classification algorithms</li>
                      </ul>
                    </Typography>
                  </Grid>
                </Grid>
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography variant="subtitle1">Biological Interpretation</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography paragraph>
                  Translating PCA results into biological insights requires integrating your domain knowledge with the patterns observed.
                  Here are some suggestions for biological interpretation:
                </Typography>

                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    <Card variant="outlined" sx={{ height: '100%' }}>
                      <CardHeader title="Pathway Analysis" titleTypographyProps={{ variant: 'subtitle2' }} />
                      <CardContent>
                        <Typography variant="body2" paragraph>
                          Consider performing pathway enrichment analysis on the top genes contributing to each principal component.
                          This can reveal which biological processes are driving the observed patterns.
                        </Typography>
                        <Typography variant="body2">
                          Tools like GSEA, DAVID, or WebGestalt can help identify enriched pathways, GO terms, or transcription factor targets.
                        </Typography>
                      </CardContent>
                    </Card>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    <Card variant="outlined" sx={{ height: '100%' }}>
                      <CardHeader title="Marker Genes" titleTypographyProps={{ variant: 'subtitle2' }} />
                      <CardContent>
                        <Typography variant="body2" paragraph>
                          Check if the genes with high loadings include known marker genes for specific cell types,
                          developmental stages, or disease states relevant to your study.
                        </Typography>
                        <Typography variant="body2">
                          The presence of specific markers can help interpret what biological factors each PC represents.
                        </Typography>
                      </CardContent>
                    </Card>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    <Card variant="outlined" sx={{ height: '100%' }}>
                      <CardHeader title="Co-expression Modules" titleTypographyProps={{ variant: 'subtitle2' }} />
                      <CardContent>
                        <Typography variant="body2" paragraph>
                          Genes with similar loading patterns (magnitude and direction) on principal components
                          often form co-expression modules that are functionally related.
                        </Typography>
                        <Typography variant="body2">
                          Consider further analyzing these gene sets with tools like WGCNA to identify regulatory networks.
                        </Typography>
                      </CardContent>
                    </Card>
                  </Grid>
                  ...
                  <Grid item xs={12} md={6}>
                    <Card variant="outlined" sx={{ height: '100%' }}>
                      <CardHeader title="Experimental Factors" titleTypographyProps={{ variant: 'subtitle2' }} />
                      <CardContent>
                        <Typography variant="body2" paragraph>
                          Examine how samples cluster in relation to experimental factors (treatment, time, tissue type, etc.)
                          to determine which factors are driving the greatest variation in your data.
                        </Typography>
                        <Typography variant="body2">
                          PCs that separate samples based on technical factors (batch, sequencing run, etc.) may represent unwanted technical variation.
                        </Typography>
                      </CardContent>
                    </Card>
                  </Grid>
            ...
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                <Typography variant="subtitle1">Recommendations & Next Steps</Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography paragraph>
                  Based on your PCA results, here are recommendations for further analysis and interpretation:
                </Typography>
                    ...
                    <Card variant="outlined">
                      <CardContent sx={{ p: 2 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                          ...
                          <Typography variant="h6">Prioritized Analysis Steps</Typography>
                        </Box>

                        <Box component="ol" sx={{ ml: 2, mt: 2 }}>
                          <Typography component="li" variant="body1" sx={{ mb: 1 }}>
                            <strong>Differential Expression Analysis</strong> - Perform tests between the groups that separate most strongly in your PCA plot along PC1.
                          </Typography>
                          <Typography component="li" variant="body1" sx={{ mb: 1 }}>
                            <strong>Gene Set Enrichment Analysis</strong> - Use top-contributing genes to identify enriched pathways and biological processes.
                          </Typography>
                          <Typography component="li" variant="body1" sx={{ mb: 1 }}>
                            <strong>Clustering Analysis</strong> - Consider clustering samples based on principal components to identify potential subgroups.
                          </Typography>
                          <Typography component="li" variant="body1" sx={{ mb: 1 }}>
                            <strong>Correlation Analysis</strong> - Correlate principal components with experimental variables to identify potential drivers of variance.
                          </Typography>
                          <Typography component="li" variant="body1">
                            <strong>Validation</strong> - Consider validating key findings using qPCR or other experimental techniques.
                          </Typography>
                        </Box>
                      </CardContent>
                    </Card>
