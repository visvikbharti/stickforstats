...
const DistributionImageCard = React.memo(({ distributionType, description }) => {
  // Default to "probability" if distributionType is not provided
  const safeType = distributionType ? distributionType : 'Probability';
  const safeImagePath = distributionType ? 
    `/static/images/distributions/${distributionType.toLowerCase()}_distribution.png` :
    '/static/images/distributions/probability_distribution.png';
  ...
  return (
    <Card>
      <CardMedia
        ...
        height="200"
        image={safeImagePath}
        alt={`${safeType} Distribution`}
      />
      <CardContent>
        <Typography variant="subtitle2" gutterBottom>
          {safeType} Distribution
        </Typography>
        <Typography variant="caption" color="text.secondary">
          {description}
        </Typography>
  ...
  return (
    <Box>
      <Typography variant="h6" gutterBottom>
        Historical Development of {distributionType && typeof distributionType === 'string' ? distributionType.replace('_', ' ') : 'Probability'} Distribution
      </Typography>
      <Typography variant="body1">
        Historical information about the {distributionType ? distributionType.toLowerCase() : 'probability'} distribution would be displayed here.
      </Typography>
    </Box>
  );
});
            ...
            <CardContent>
              ...
              <Box sx={{ height: '400px' }}>
                {distributionType ? 
                  ...
                  <Typography variant="body2">Please select a distribution type to see the animation.</Typography>
                }
              </Box>
            </CardContent>
          </Card>
...
const Applications = React.memo(({ distributionType }) => {
  ...
  return (
    <Box>
      <Typography variant="h6" gutterBottom>
        Real-world Applications of the {distributionType && typeof distributionType === 'string' ? distributionType.replace('_', ' ') : 'Probability'} Distribution
      </Typography>
      
      <Typography variant="body2" paragraph>
        The {distributionType ? distributionType.toLowerCase() : 'probability'} distribution is applied in numerous fields to model real-world phenomena.
      </Typography>
      ...
      <Box sx={{ width: '100%' }}>
        <Paper sx={{ p: 2, mb: 3 }}>
          ...
          <TabPanel value={activeTab} index={0}>
            <Box>
              <Typography variant="h6" gutterBottom>
                Understanding {distributionType && typeof distributionType === 'string' ? distributionType.replace('_', ' ') : 'Probability'} Distribution
              </Typography>
