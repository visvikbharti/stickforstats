...
const NonNormalitySimulation = ({ projectId }) => {
  ...
  const handleRunSimulation = () => {
    ...
    const simulationParams = {
      action: 'start_non_normality_simulation',
      params: {
    ...
    switch (distributionType) {
      case 'SKEWED':
        simulationParams.params.dist_params = {
          skewness: distributionParams.skewness
        };
        break;
      case 'HEAVY_TAILED':
        simulationParams.params.dist_params = {
          df: distributionParams.heaviness
        };
        break;
      case 'CONTAMINATED':
        simulationParams.params.dist_params = {
          contamination: distributionParams.contamination,
          outlier_mean: distributionParams.outlierMean,
          outlier_std: distributionParams.outlierStd
        };
        break;
      case 'BIMODAL':
        simulationParams.params.dist_params = {
          separation: distributionParams.bimodalSeparation,
          ratio: distributionParams.bimodalRatio
        };
        break;
      case 'DISCRETE':
        simulationParams.params.dist_params = {
          // Default parameters for discrete distribution
          // This could be a distribution with support on a few points
        };
        break;
      default:
        simulationParams.params.dist_params = {
